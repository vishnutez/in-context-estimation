...
np.save(f'../Files/v1_5_CE_{task}_{run_id}.npy', v1_CE)
np.save(f'../Files/v2_15_CE_{task}_{run_id}.npy', v2_CE)
np.save(f'../Files/v3_30_CE_{task}_{run_id}.npy', v3_CE)


# np.save(f'../Files/v1_5_Acc_{task}.npy', v1_acc)
# np.save(f'../Files/v2_15_Acc_{task}.npy', v2_acc)
# np.save(f'../Files/v3_30_Acc_{task}.npy', v3_acc)
